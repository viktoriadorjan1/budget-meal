...
Future<List<String>> getUnitsForCategoryFromDB(String category) async {
...
Future<List<String>> getUnitsForIngredientFromDB(String ingredientName) async {
  String uri = "mongodb+srv://admin:JKEw0feoZCxOE0LS@cluster0.m5iuzzq.mongodb.net:27017/webstores";
  ...
  var entries = await collection.find(where.eq("ingredientName", ingredientName)).toList();
